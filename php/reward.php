...
// include "public/public_db.php";
    class Reward{
      ...
      function queryRewardList(){
        ...
        $sql="SELECT * from reward rew,student stu,department dep,science sci,class cla where rew.stu_id = stu.student_id and stu.department_id = dep.id and stu.science_id = sci.id and stu.class_id = cla.id  $kl";
